...
#pragma config(Sensor, dgtl5,  limitMG,        sensorTouch)
...
#pragma config(Motor,  port3,           torreTopLeft,  tmotorVex393HighSpeed_MC29, openLoop, driveLeft)
...
#pragma config(Motor,  port7,           baseMG,        tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port8,           chainPivot,    tmotorVex393HighSpeed_MC29, openLoop, driveRight)
